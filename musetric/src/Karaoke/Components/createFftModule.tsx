...
import { frequencySize, width, windowSize, workgroupSize } from './common';
...
const fftShaderCode = `
    ...
    fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
        let windowIndex = global_id.x;
        let line = windowIndex / frequencySize;
        let frequency = windowIndex % frequencySize;
...
// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
    ...
    return {
        render: (commandEncoder: GPUCommandEncoder): void => {
            ...
            passEncoder.dispatchWorkgroups(Math.ceil(frequencySize * width / workgroupSize));
            passEncoder.end();
        },
