...
export const createFps = () => {
    ...
    return {
        draw: (newTime: number, src: string): void => {
            ...
            document.getElementById('1')!.textContent = (maxTime / 1000).toFixed(2);
            document.getElementById('2')!.textContent = (time / 1000).toFixed(2);
            document.getElementById('3')!.textContent = (minTime / 1000).toFixed(2);
